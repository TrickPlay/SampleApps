...
videoLoadedHandler    = nil
loadFailureHandler    = nil
videoCompletedHandler = nil
...
removeLoadHandlers()
	...
	-- Remove the video-load event handlers
	mediaplayer:remove_onloaded_listener( videoLoadedHandler )
	mediaplayer:remove_onerror_listener( loadFailureHandler )
	videoLoadedHandler = nil
	loadFailureHandler = nil

end  -- removeLoadHandlers()
...
videoLoaded()
	...
	-- Remove all load event handlers
	removeLoadHandlers()
	...
	-- Register an on_end_of_stream event handler that will be invoked after
	-- the video has finished playing.
	videoCompletedHandler = mediaplayer:add_onendofstream_listener( videoCompleted )
...
videoCompleted()
	...
	-- Unregister the on_end_of_stream event handler
	mediaplayer:remove_onendofstream_listener( videoCompletedHandler )
	videoCompletedHandler = nil
...
playVideo()
	...
	-- If video was already playing, clear the current event handler
	if( videoCompletedHandler ~= nil )then
		mediaplayer:remove_onendofstream_listener( videoCompletedHandler )
		videoCompletedHandler = nil
	end

	-- Register video-load event handlers
	videoLoadedHandler = mediaplayer:add_onloaded_listener( videoLoaded )
	loadFailureHandler = mediaplayer:add_onerror_listener( videoError )
...
screen:add_onkeydown_listener( playVideo )
