...
animateCharacters()
	...
	-- animation after the character animation is finished. This requires registering an
	-- on_completed event handler.
	doneTimeline = Timeline()
	doneTimeline:add_oncompleted_listener( charAnimationFinished )
