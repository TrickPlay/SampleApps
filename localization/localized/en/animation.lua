...
local billbrd = ...
	...
	-- Create timeline to implement Phase One/Rotation about the Y-axis
	...
	-- Create timeline to implement Phase Two/Rotation about the Y-axis
